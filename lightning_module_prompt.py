...
class PromptModelPLModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss,loss_token,loss_position = self.model(image_tensors, pre_input_ids, attention_masks, label_ids, prompts)[0] #CrossEntropyLoss()+IoU_loss()
        if loss is not None:
    ...
    def validation_step(self, batch, batch_idx, dataset_idx=0):
        ...
        if prompts.shape[1] != logits.shape[1]:  # 非全文prompt 
